...
bool SystemTest::PhysicsSystem()
{
    ...
    Component::com_Transform camTransform(glm::vec3(50, 10, 0.2), glm::vec3(0), glm::vec3(1));
    Component::com_Transform camTransform2(glm::vec3(-50, 10,-0.2), glm::vec3(0), glm::vec3(1));
